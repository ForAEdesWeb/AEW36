				    ...
				    <?php endif; ?>
					  <form action="<?php echo JRoute::_('index.php', true, $params->get('usesecure')); ?>" method="post" name="form-login" id="login-form" >
							...
							<div class="action-button">
								...
								<button class="button btn btn-lg btn-primary btn-decor" ><?php echo JText::_('JABUTTON_LOGIN'); ?></button>
						...
						<div class="tab-pane <?php if(!empty($captchatext)) echo 'hascaptcha'; ?>" id="ja-user-register"  >
							...
							<form id="member-registration" action="<?php echo JRoute::_('index.php?option=com_users&task=registration.register'); ?>" method="post" class="form-validate">
								...
								<div class="action-button">
									...
									<button type="submit" class="validate btn btn-lg btn-primary btn-decor"><?php echo JText::_('JAREGISTER');?></button>
									<div>
										<input type="hidden" name="option" value="com_users" />
...
<ul class="ja-login<?php echo $params->get('moduleclass_sfx','')?>">
	<?php if($type == 'logout') : ?>
		...
		<?php else : ?>
		<li>
			<a class="login-switch" href="#" data-toggle="modal" data-target="#ja-login-form" title="<?php echo JText::_('TXT_LOGIN');?>"><span><?php echo JText::_('TXT_LOGIN');?></span></a>
		</li>
		<?php
