...
jQuery(function(){
    ...
    ?>
    <div class="vrcsfentrycont"><div class="vrcsfentrysubmit"><button class="btn btn-lg btn-decor btn-primary"><?php echo (strlen($params->get('srchbtntext')) > 0 ? $params->get('srchbtntext') : JText::_('SEARCHD')); ?></button></div></div>
    </form>
</div>
</div>
