...
<div class="catItemView group<?php echo ucfirst($this->item->itemGroup); ?><?php echo ($this->item->featured) ? ' catItemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
	    ...
	    <?php foreach ($this->item->extra_fields as $key=>$extraField): ?>
			<?php if($extraField->value != ''): ?>
				<?php if($extraField->name == 'Price'): ?>
					<?php echo '<div class="item-price">'.$extraField->value.'</div>'; ?>
				<?php endif; ?>
			<?php endif; ?>
			<?php endforeach; ?>
	  </span>
	  ...
	  <div class="catItemExtraFields">
	  	...
	  	<ul>
			...
			<li class="<?php echo ($key%2) ? "odd" : "even"; ?> type<?php echo ucfirst($extraField->type); ?> group<?php echo $extraField->group; ?>">
				...
				<?php elseif($extraField->name == 'Mobile' || $extraField->name == 'Fax' || $extraField->name == 'Email'|| $extraField->name == 'Skype'): ?>
  ...
  <div class="catItemFooter">
		...
		<?php if($extraField->name == 'GooglePlus' || $extraField->name == 'Linkedin' || $extraField->name == 'Facebook'|| $extraField->name == 'Twitter' || $extraField->name == 'Characteristic'): ?>
		...
		<?php 
			switch ($extraField->name) {
			    ...
			    case 'Twitter':
			        ...
			        break;
			    case 'Characteristic':
			    		echo '<span class="pull-right">'.$extraField->value.'</span>';
			        break;
			}
		?>
		<?php endif; ?>
