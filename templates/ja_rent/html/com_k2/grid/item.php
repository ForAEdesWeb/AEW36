...
<div id="k2Container" class="itemGrid itemView<?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
		  ...
		  <div class="col-xs-12 col-md-4">
			  ...
			  <div class="itemExtraFields">
			  	...
			  	<ul>
					...
					<?php if($extraField->value != '' && !($extraField->name == 'GooglePlus' || $extraField->name == 'Linkedin' || $extraField->name == 'Facebook'|| $extraField->name == 'Twitter')): ?>
						<?php if($extraField->name == 'Mobile' || $extraField->name == 'Fax' || $extraField->name == 'Email'|| $extraField->name == 'Skype' || $extraField->name == 'Characteristic'): ?>
							<li class="<?php echo ($key%2) ? "odd" : "even"; ?> type<?php echo ucfirst($extraField->type); ?> group<?php echo $extraField->group; ?>">
							<?php if($extraField->name == 'Skype'): ?> <a href="skype:<?php echo $extraField->value; ?>?call"><?php endif; ?>
							...
							<?php if($extraField->name == 'Skype'): ?> </a><?php endif; ?>
						</li>
						<?php endif; ?>
					<?php endif; ?>
					<?php if($extraField->name == 'GooglePlus' || $extraField->name == 'Linkedin' || $extraField->name == 'Facebook'|| $extraField->name == 'Twitter'): ?>
					<?php 
						switch ($extraField->name) {
						    case 'GooglePlus':
						        echo '<a href="https://plus.google.com/'.$extraField->value.'" title="'.$extraField->value.'" target="_blank"><i class="fa fa-google-plus"></i>/a>';
						        break;
						    case 'Linkedin':
						        echo '<a href="http://www.linkedin.com/in/'.$extraField->value.'" title="'.$extraField->value.'" target="_blank"><i class="fa fa-linkedin"></i></a>';
						        break;
						    case 'Facebook':
						        echo '<a href="http://facebook.com/'.$extraField->value.'" title="'.$extraField->value.'" target="_blank"><i class="fa fa-facebook"></i></a>';
						        break;
						    case 'Twitter':
						    		echo '<a href="https://twitter.com/'.$extraField->value.'" title="'.$extraField->value.'" target="_blank"><i class="fa fa-twitter"></i></a>';
						        break;
						}
					?>
					<?php endif; ?>
